...
class Page{
    ...
    public function show() {
		...
		if(empty($this->url)){
			...
			$this->url = rtrim(U('/'.$this->url,'',false),$depr).urlencode('[PAGE]').'.'.C('URL_HTML_SUFFIX');//page_1.html
			//$this->url = rtrim(U('/'.$this->url,'',false),$depr).$depr.urlencode('[PAGE]').'.'.C('URL_HTML_SUFFIX');//page_/2.html
			//echo $this->url ;
		}
